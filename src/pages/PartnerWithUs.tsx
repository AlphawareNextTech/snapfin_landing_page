            ...
            <div className="animate-fade-up">
              {!isSubmitted ? <div className="bg-card rounded-3xl border border-border shadow-snapfin-xl p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <FormInput label="Business Email" type="email" placeholder="work@company.com" value={formData.email} onChange={e => setFormData(prev => ({
                    ...prev,
                    email: e.target.value
                  }))} error={errors.email} required />
                      <FormInput label="Phone Number" placeholder="10-digit number" value={formData.phone} onChange={e => setFormData(prev => ({
                    ...prev,
