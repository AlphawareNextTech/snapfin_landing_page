        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/10 border border-secondary/20 mb-6 animate-fade-up">
              ...
              <span className="text-sm font-medium text-secondary">Trusted by 10,000+ customers</span>
            </div>
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight mb-6 animate-fade-up delay-100">
              Get the right loan.
              <br />
              <span className="text-primary">Fast. Clear. Confident.</span>
            </h1>

            {/* Subhead */}
            <p className="text-lg sm:text-xl text-muted-foreground max-w-xl mx-auto lg:mx-0 mb-8 animate-fade-up delay-200">
              Smart matching for LAP, Personal, and Business Loans with transparent terms and quick approvals.
            </p>
                ...
                <div className="bg-muted/50 rounded-2xl p-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select className="w-full h-12 px-4 rounded-xl bg-background border border-border text-foreground focus:outline-none focus:ring-2 focus:ring-secondary/50">
